...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClipboardItem.is_copy'
        db.add_column('image_filer_clipboarditem', 'is_copy', orm['image_filer.clipboarditem:is_copy'])
        
        # Changing field 'FolderPublication.folder'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['image_filer.Folder']))
        db.alter_column('cmsplugin_imagefolder', 'folder_id', orm['image_filer.folderpublication:folder'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ClipboardItem.is_copy'
        db.delete_column('image_filer_clipboarditem', 'is_copy')
        
        # Changing field 'FolderPublication.folder'
        # (to signature: ImageFilerModelFolderField())
        db.alter_column('cmsplugin_imagefolder', 'folder_id', orm['image_filer.folderpublication:folder'])
    ...
    models = {
        ...
        'image_filer.clipboarditem': {
            ...
            'is_copy': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
        'image_filer.folder': {
        ...
        'image_filer.folderpublication': {
            ...
            'folder': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['image_filer.Folder']"})
        },
        'image_filer.image': {
